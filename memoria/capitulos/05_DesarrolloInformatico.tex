...
En la segunda prueba hay muchos más casos de prueba. Se varían los parámetros \texttt{expl\_var} (entre 0.6, 0.8 y 0.95), \texttt{ncores} (entre 1, 2 y 4), \texttt{k\_max} (entre 3, 7 y 10), \texttt{T} (entre 32, 256 y 512) y \texttt{m} (entre 32, 256 y 512), mientras que el tipo de serie se ha mantenido constante a las generadas por el método de Monte Carlo. Los resultados pueden verse en %TODO enlace a git porque vaya
