...
\usepackage[colorlinks=true,linkcolor=black,citecolor=blue]{hyperref} %referencia
...
%
\input{capitulos/02_DesarrolloMatematico}
%
\input{capitulos/03_DesarrolloInformatico}
%
